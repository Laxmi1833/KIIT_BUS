export default function Footer() {
  return (
    <footer className="bg-dark text-slate mt-16">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-white text-lg font-bold mb-4">UniTransport</h3>
            <p className="text-sm leading-relaxed mb-4">
              Providing safe, reliable, and efficient transportation services for university students and staff.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              <p>Transport Office, Campus 25</p>
              <p>Phone: +1 (555) 123-4567</p>
              <p>Email: transport@university.edu</p>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>Bus Service: 6:30 AM - 9:00 PM</p>
            </div>
          </div>
        </div>

        <div className="text-center pt-8 border-t border-gray-800 text-sm">
          <p>&copy; 2024 University Transport Management System. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
